...
/**
 * The location class for a shark which stores the longitude and the latitude
 * as well as the distance all as doubles
 * 
...
public class SharkLocation {
	...
	/**
	 * Constructor for the sharkLocation class 
	 * which sets the current shark object
	 * 
	 ...
	 * @param distance The input distance to be set as a double
	 */
	 ...
	 * @param lat The latitude input as a double
	 */
	 ...
	 * @param lon The longitude input as a double
	 */
